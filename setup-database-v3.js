...
// Función para ejecutar SQL vía RPC
...
async function setupDatabase() {
  ...
  // PASO 1: Crear función para ejecutar SQL
  ...
  try {
    ...
    console.log('⚠️  Ya existe o hubo un error (continuando...)\n')
  }

  // PASO 2: Crear tabla users
  console.log('📋 PASO 2: Creando tabla users...')
  ...
  // PASO 3: Crear tabla appointments
  console.log('📋 PASO 3: Creando tabla appointments...')
  ...
  // PASO 4: Crear tabla interaction_logs
  console.log('📋 PASO 4: Creando tabla interaction_logs...')
  ...
  console.log('📋 PASO 6: Creando trigger para updated_at...')
  ...
  console.log('🔍 PASO 7: Verificando tablas...\n')
